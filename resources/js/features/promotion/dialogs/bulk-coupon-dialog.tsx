...
export default function BulkCouponDialog({ open, onOpenChange, promotionId, onSuccess }: BulkCouponDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg" onOpenAutoFocus={(e) => e.preventDefault()}>
        <DialogHeader>
          <DialogTitle>{tProm('bulk.title', 'Bulk Generate Coupons')}</DialogTitle>
          <DialogDescription>
            {tProm('bulk.desc', 'Create one or many coupon codes at once.')}
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter>
          ...
          <Button type="button" disabled={processing} onClick={submit}>{t('common.submit', 'Submit')}</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
