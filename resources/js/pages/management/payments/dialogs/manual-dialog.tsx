...
import InvoiceLookup from '@/pages/management/payments/components/invoice-lookup';
import PaymentDetailsForm from '@/pages/management/payments/components/payment-details-form';
import type {
