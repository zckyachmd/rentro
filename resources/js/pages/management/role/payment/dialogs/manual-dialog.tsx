...
import {
    InvoiceLookup,
    PaymentDetailsForm,
} from '@/pages/management/role/payment/components';
import type {
                ...
                <div className="space-y-3 text-sm">
                    <div className="space-y-1">
                        ...
                        <InvoiceLookup
                            ...
                            onChange={(v: string, opt?: SearchOption) => {
                    ...
                    {resolvedInvoice?.eligible ? (
                        <PaymentDetailsForm
                            ...
                            onMethod={(v: string) => setData('method', v)}
                            onPaidAt={(v: string) => setData('paid_at', v)}
                            onAmount={(v: number | '') =>
                                setData(
                                    'amount_idr',
                            ...
                            onNote={(v: string) => setData('note', v)}
                            onAttachment={(f: File | null) =>
                                setData('attachment', f)
                            }
                            manualBanks={manualBanks}
                            receiverBank={receiverBank}
                            onReceiverBank={(v: string) => setReceiverBank(v)}
                        />
                    ) : null}
                </div>
                <DialogFooter>
