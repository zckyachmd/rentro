...
import {
    ...
    PaymentReviewDialog,
    VoidPaymentDialog,
} from '@/pages/management/role/payment/dialogs';
import { createColumns } from '@/pages/management/role/payment/tables/columns';
import type {
                    ...
                    <CardContent>
                        <DataTableServer<PaymentRow, unknown>
                            columns={createColumns({
                                ...
                                onShowDetail: (row: PaymentRow) =>
                                    setDetail({ id: row.id }),
                                onReview: (row: PaymentRow) =>
                                    setReview({ id: row.id }),
                                currency,
                            })}
                            rows={rows}
