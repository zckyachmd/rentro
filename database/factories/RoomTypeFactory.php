...
class RoomTypeFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'capacity'        => [1, 2, 2][$idx],
            'prices'          => [
                'daily'   => (int) ($priceDailyIdr * 100),
                'weekly'  => (int) ($priceWeeklyIdr * 100),
                'monthly' => (int) ($priceMonthlyIdr * 100),
            ],
            'deposits'        => [
                'daily'   => (int) ($depositDailyIdr * 100),
                'weekly'  => (int) ($depositWeeklyIdr * 100),
                'monthly' => (int) ($depositMonthlyIdr * 100),
            ],
